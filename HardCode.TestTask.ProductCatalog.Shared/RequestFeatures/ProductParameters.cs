...
public sealed class ProductParameters
{
    ...
    /// </summary>
    [FromQuery(Name = "min-price")] public decimal MinPrice { get; set; } = decimal.MinValue;
    /// <summary>
    /// Фильтрация по цене (максимальная цена)
    /// </summary>
    [FromQuery(Name = "max-price")] public decimal MaxPrice { get; set; } = decimal.MaxValue;
    /// <summary>
    /// Фильтрация по категории
    /// </summary>
    [FromQuery(Name = "category")] public int? Category { get; set; }
}